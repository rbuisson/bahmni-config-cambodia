Bahmni.ConceptSet.FormConditions.rules = {
    ...
    'CAMBODIA_Genitourinary Exam' : function (formName, formFieldValues) {
        var fieldValue = formFieldValues['CAMBODIA_Genitourinary Exam'];
        if (fieldValue == "CAMBODIA_Abnormal") {
            return {
                enable: ["CAMBODIA_Genitourinary Exam Details", "CAMBODIA_Genitourinary Exam Abnormalities"]
            }
        } else {
            return {
                disable: ["CAMBODIA_Genitourinary Exam Details", "CAMBODIA_Genitourinary Exam Abnormalities"]
            }
        }
